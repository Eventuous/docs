...
2. It passes the command over to the application service. As the edge is responsible for authentication and some authorization, it can enrich commands with user credentials.
...
Eventuous gives you a base class to implement command services in the application layer: the `CommandService`.
