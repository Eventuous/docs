...
|:-------------------------------------------------------|:--------------------|
| [Elasticsearch](targets/elastic-target)                | producer, projector |
| [MongoDB](targets/mongo-target)                        | projector           |
| [MS SQL Server or Azure SQL](targets/sqlserver-target) | projector           |
